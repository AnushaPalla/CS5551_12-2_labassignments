...
public class HomeActivity extends AppCompatActivity {
    private static final String CLOUD_VISION_API_KEY = "AIzaSyBqF3T1WtuYyPVn7GinDlUFhglW0fQvd_E";
    ...
    public void startCameraS(View v)
    {
        startCamera();
    }
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String result) {
            HomeActivity activity = mActivityWeakReference.get();
